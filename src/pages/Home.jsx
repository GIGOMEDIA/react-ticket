    ...
    <div className="min-h-screen bg-linear-to-b from-blue-50 to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <header className="pt-12 pb-16 text-center">
          <h1 className="text-5xl md:text-6xl font-extrabold  mb-6 bg-clip-text text-transparent bg-linear-to-r from-blue-600 to-indigo-600">
            TicketDash
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Button
              variant="primary"
              className="px-8 py-3 text-lg hover:bg-blue-300 cursor-pointer hover:scale-105"
            ...
            <Button
              variant="outline"
              className="px-10 py-3 text-lg hover:scale-105 cursor-pointer hover:bg-blue-500 hover:text-white"
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-left">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Experience the next generation of ticket management with our
                intuitive platform. Designed for teams of all sizes to track,
                prioritize, and resolve issues faster than ever.
              </p>
              <div className="flex flex-wrap gap-4">
                <Button
                  variant="primary"
                  size="lg"
                  className="hover:bg-blue-300 cursor-pointer hover:scale-105"
                >
                  Start Free Trial
                </Button>
                <Button
                  variant="outline"
                  size="lg"
                  className="hover:scale-105 cursor-pointer hover:bg-blue-500 hover:text-white"
                >
                  Watch Demo
                </Button>
              </div>
